...
const FounderSection = () => {
  return (
    <div>
      <section className="my-8 w-80 md:w-auto dark:bg-gray-100 dark:text-gray-800">
        <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
          ...
          <p className="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl dark:text-gray-700">
            Celebrating the visionary behind Journey Juggler, dedicated to
            crafting personalized, unforgettable travel experiences for all.
          </p>
          <div className="flex justify-center space-x-3">
            ...
            />
            <div>
              <p className="leading-tight">Lovely Pandey</p>
              ...
              <a
                ...
                href="https://www.linkedin.com/in/lovely-pandey-ab2180255/"
              >
